...
const SelfMessageIndicator=()=>(
	<div className="absolute bg-green-chatr top-0-right-[3px] w-3 h-3 rounded-bl-full overflow-hidden" />
);

const TextMessage=({message}:{message:IMessage})=>{
	const isLink=/^(ftp|https|https):\/\/[^"]+$/.test(message.content); //URL content
